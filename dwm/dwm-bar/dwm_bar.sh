...
. "$DIR/bar-functions/dwm_networkmanager.sh" # dep - NetworkManager, curl
. "$DIR/bar-functions/dwm_loadavg.sh"
. "$DIR/bar-functions/dwm_inhibitor.sh"
# . "$DIR/bar-functions/dwm_connman.sh" # alternative to dwm_networkmanager
